 ...
 @namespace    httpsviolentmonkey.github.io
 @version      4.0.1
 @description  Working Recipe calculator after the nut incident.
 @author       SKRIP
 @match        httpssulfur.wiki.gg
 @icon         httpssulfur.wiki.ggfavicon.ico
 @grant        GM_addStyle
...
(function() {
    'use strict';
     ...
     CONFIG thingies
    const CONFIG = {
        DEFAULT_IMAGE 'httpssulfur.wiki.ggimages665Twerker.png47b5c1=&format=original',
        DEBOUNCE_DELAY 300,
        TOOLTIP_DELAY 500,
    ...
    class GameData {
        static ingredients = {
                    'Anti-Poison Gum' {
                        image 'httpssulfur.wiki.ggimages999Anti-Poison_Gum.png68510b',
                    ...
                    'Banana' {
                        image 'httpssulfur.wiki.ggimages669Banana.pngc9ace2',
                    ...
                    'Bark' {
                        image 'httpssulfur.wiki.ggimagesddcBark.png133c2d',
                    ...
                    'Bark Bread' {
                        image 'httpssulfur.wiki.ggimagesfffBark_Bread.png6e2ec3',
                    ...
                    'Beans' {
                        image 'httpssulfur.wiki.ggimagesthumb99fBeans.png104px-Beans.png109a6e',
                    ...
                    'Beef Jerky' {
                        image 'httpssulfur.wiki.ggimagesee4Beef_Jerky.png942c0f',
                    ...
                    'Berries' {
                        image 'httpssulfur.wiki.ggimages224Berries.pngfbabb9',
                    ...
                    'Berry Jam' {
                        image 'httpssulfur.wiki.ggimagesaa6Berry_Jam.png364fa5',
                    ...
                    'Black Pepper' {
                        image 'httpssulfur.wiki.ggimages222Black_Pepper.png5917f9',
                    ...
                    'Bladder' {
                        image 'httpssulfur.wiki.ggimagesthumb996Bladder.png200px-Bladder.png6ab437',
                    ...
                    'Bleach' {
                        image 'httpssulfur.wiki.ggimagesthumbeeaBleach.png69px-Bleach.pngd59601',
                    ...
                    'Brain' {
                        image 'httpssulfur.wiki.ggimagesthumb33fBrain.png200px-Brain.png2d09a8',
                        type 'Ingredient', gridSize '1x1', sellPrice 100, buyPrice 0,
                        soldBy '', effect '', statsModifiers '',
                        flavorText 'The mind is a terrible thing to waste.'
                    },
                    'Bread' {
                        image 'httpssulfur.wiki.ggimagesee1Bread.pngffd5cb',
                    ...
                    'Buttermilk' {
                        image 'httpssulfur.wiki.ggimagesthumb119Buttermilk.png100px-Buttermilk.png85204b',
                    ...
                    'Cacao' {
                        image 'httpssulfur.wiki.ggimages660Cacao.png8437ea',
                    ...
                    'Cactus' {
                        image 'httpssulfur.wiki.ggimagesthumbaa6Cactus.png200px-Cactus.pngda0343',
                    ...
                    'Cheese' {
                        image 'httpssulfur.wiki.ggimagesaa5Cheese.pngff8619',
                    ...
                    'Chicken Leg' {
                        image 'httpssulfur.wiki.ggimages116Chicken_Leg.pngfa7b4a',
                    ...
                    'Chocolate Bar' {
                        image 'httpssulfur.wiki.ggimagescc5Chocolate_Bar.pngdc841f',
                    ...
                    'Chocolate Syrup' {
                        image 'httpssulfur.wiki.ggimagesthumbee8Chocolate_Syrup.png85px-Chocolate_Syrup.png438251',
                        type 'Consumable', gridSize '1x2', sellPrice 50, buyPrice 0,
                        soldBy '', effect 'Heal 10 health over 10 seconds', statsModifiers '',
                        flavorText 'A thick, sugary, chocolate liquid.'
                    },
                    'Christmas Spice' {
                        image 'httpssulfur.wiki.ggimages00aChristmas_Spice.pngcf6a9f',
                    ...
                    'Cloth' {
                        image 'httpssulfur.wiki.ggimagesthumb551Cloth.png200px-Cloth.pngfe4359',
                    ...
                    'Coffee' {
                        image 'httpssulfur.wiki.ggimagesee9Coffee.png58e1ff',
                    ...
                    'Craw Flesh' {
                        image 'httpssulfur.wiki.ggimagesthumb449Craw_Flesh.png200px-Craw_Flesh.pngf76748',
                    ...
                    'Craw Skin' {
                        image 'httpssulfur.wiki.ggimagesthumb996Craw_Skin.png200px-Craw_Skin.png50704b',
                        type 'Ingredient', gridSize '1x1', sellPrice 15, buyPrice 0,
                        soldBy 'Qiosk', effect '', statsModifiers '',
                        flavorText 'The oily feathers repel water and insulates.'
                    },
                    'Dog Eye' {
                        image 'httpssulfur.wiki.ggimagesthumbaa4Dog_Eye.png200px-Dog_Eye.pngd41d5c',
                        type 'Ingredient', gridSize '1x1', sellPrice 15, buyPrice 0,
                        soldBy '', effect '', statsModifiers '',
                        flavorText 'Sounds a bit like the name for a flower, but upon closer examination it is certainly not.'
                    },
                    'Dog Flesh' {
                        image 'httpssulfur.wiki.ggimagesthumbff9Dog_Flesh.png200px-Dog_Flesh.png528131',
                        type ' Ingredient', gridSize '1x1', sellPrice 23, buyPrice 0,
                        soldBy '', effect '', statsModifiers '',
                        flavorText 'A sizable part of man`s best friend.'
                    },
                    'Dog Skin' {
                        image 'httpssulfur.wiki.ggimagesthumbbb8Dog_Skin.png200px-Dog_Skin.pngb96441',
                        type 'Ingredient', gridSize '1x1', sellPrice 20, buyPrice 0,
                        soldBy '', effect '', statsModifiers '',
                        flavorText 'Would look great on a dog!'
                    },
                    'Egg' {
                        image 'httpssulfur.wiki.ggimagesthumb226Egg.png117px-Egg.png3e325a',
                    ...
                    'False Sulfcap' {
                        image 'httpssulfur.wiki.ggimages441False_Sulfcap.pngef15fc',
                    ...
                    'Fatberg Chunk' {
                        image 'httpssulfur.wiki.ggimagesthumbee4Fatberg_Chunk.png160px-Fatberg_Chunk.pngedb1e3',
                    ...
                    'Fathers Shirt' {
                        image 'httpssulfur.wiki.ggimagesthumb22aFather%27s_Shirt.png187px-Father%27s_Shirt.png173653',
                    ...
                    'Fish' {
                        image 'httpssulfur.wiki.ggimagesffbFish.png110d20',
                        type 'Consumable', gridSize '1x1', sellPrice 20, buyPrice 40,
                    ...
                    'Flat Sandfish' {
                        image 'httpssulfur.wiki.ggimagesthumb33fFlat_Sandfish.png160px-Flat_Sandfish.png4bc905',
                        type 'Consumable', gridSize '1x1', sellPrice 20, buyPrice 40,
                        soldBy '', effect 'Heal 10 health over 2.5 seconds', statsModifiers '',
                        flavorText 'An uncooked fish. May be cooked or eaten raw if prepared correctly.'
                    },
                    'Flour' {
                        image 'httpssulfur.wiki.ggimagesee8Flour.png2047f8',
                    ...
                    'Frog Leg' {
                        image 'httpssulfur.wiki.ggimages99fFrog_Leg.png368ab4',
                        type 'Consumable', gridSize '1x1', sellPrice 30, buyPrice 60,
                    ...
                    'Goblin Flesh' {
                        image 'httpssulfur.wiki.ggimagesthumb771Goblin_Flesh.png160px-Goblin_Flesh.pngee6447',
                        type 'Ingredient', gridSize '1x1', sellPrice 25, buyPrice 50,
                        soldBy '', effect '', statsModifiers '',
                        flavorText 'Surprisingly mushy...'
                    },
                    'Goblin Skin' {
                        image 'httpssulfur.wiki.ggimagesthumbbb6Goblin_Skin.png200px-Goblin_Skin.pnga9a66b',
                        type 'Ingredient', gridSize '1x1', sellPrice 15, buyPrice 0,
                        soldBy '', effect '', statsModifiers '',
                        flavorText 'Fells like a wet suit...'
                    },
                    'Gravy' {
                        image 'httpssulfur.wiki.ggimagesthumb33dGravy.png200px-Gravy.png56f65e',
                        type 'Consumable', gridSize '2x1', sellPrice 30, buyPrice 0,
                        soldBy '', effect 'Heal 20 health over 10 seconds', statsModifiers '',
                        flavorText 'A white, brown, or gray standard sauce.'
                    },
                    'Green Glob' {
                        image 'httpssulfur.wiki.ggimagesff7Green_Glob.pngff625a',
                        type 'Item', gridSize '1x1', sellPrice 20, buyPrice 40,
                        soldBy 'Stiffleg', effect '', statsModifiers '',
                        flavorText 'Smells funky.'
                    },
                    'Green Tea' {
                        image 'httpssulfur.wiki.ggimages88fGreen_Tea.png99ba15',
                    ...
                    'Green Tunic' {
                        image 'httpssulfur.wiki.ggimagesthumbaa7Green_Tunic.png188px-Green_Tunic.pngfbab71',
                    ...
                    'Hazelnut' {
                        image 'httpssulfur.wiki.ggimages331Hazelnut.png5455e2',
                    ...
                    'Heart' {
                        image 'httpssulfur.wiki.ggimagesthumbdd9Heart.png200px-Heart.png386bf0',
                        type 'Ingredient', gridSize '1x1', sellPrice 100, buyPrice 0,
                        soldBy 'Grossberg', effect '', statsModifiers '',
                        flavorText 'The ticker. Used to keep everything going nice and steady.'
                    },
                    'Hellshrew Flesh' {
                        image 'httpssulfur.wiki.ggimagesthumb771Hellshrew_Flesh.png198px-Hellshrew_Flesh.pngd75bf2',
                        type 'Ingredient', gridSize '1x1', sellPrice 35, buyPrice 0,
                        soldBy '', effect '', statsModifiers '',
                        flavorText 'It feels very dense.'
                    },
                    'Hellshrew Skin' {
                        image 'httpssulfur.wiki.ggimagesthumb775Hellshrew_Skin.png160px-Hellshrew_Skin.pngdbcec9',
                        type 'Item', gridSize '1x1', sellPrice 10, buyPrice 20,
                        soldBy ' Grossberg', effect '', statsModifiers '',
                        flavorText 'It`s so dry it almost breaks when handled.'
                    },
                    'Herbs' {
                        image 'httpssulfur.wiki.ggimages779Herbs.pngba3ad3',
                        type 'Consumable', gridSize '1x1', sellPrice 10, buyPrice 0,
                    ...
                    'Holy Toast' {
                        image 'httpssulfur.wiki.ggimagescccHoly_Toast.png4c31a7',
                    ...
                    'Holy Water' {
                        image 'httpssulfur.wiki.ggimagesthumb225Holy_Water.png85px-Holy_Water.png5e7fb9',
                    ...
                    'Karl-Oskar' {
                        image 'httpssulfur.wiki.ggimages116Karl-Oskar.pnge467f9',
                    ...
                    'Kidney' {
                        image 'httpssulfur.wiki.ggimagesthumb99eKidney.png200px-Kidney.pngf84a78',
                        type 'Ingredient', gridSize '1x1', sellPrice 50, buyPrice 0,
                        soldBy 'Rat Queen, Qiosk', effect '', statsModifiers '',
                        flavorText 'Filters your blood from all that bad stuff. Also makes piss!'
                    },
                    'Kidney Stone' {
                        image 'httpssulfur.wiki.ggimages664Kidney_Stone.png361419',
                        type 'Consumable', gridSize '1x1', sellPrice 30, buyPrice 60,
                    ...
                    'Leverpastej' {
                        image 'httpssulfur.wiki.ggimages665Leverpastej.png9bfcb9',
                        type 'Consumable', gridSize '2x1', sellPrice 30, buyPrice 60,
                    ...
                    'Liquor' {
                        image 'httpssulfur.wiki.ggimagesthumb44fLiquor.png76px-Liquor.pngb61dcf',
                    ...
                    'Liver' {
                        image 'httpssulfur.wiki.ggimagesthumbff6Liver.png300px-Liver.png68f6b0',
                    ...
                    'Low Fat Milk' {
                        image 'httpssulfur.wiki.ggimagesthumbeefLow_Fat_Milk.png100px-Low_Fat_Milk.pngbe88f5',
                    ...
                    'Lung' {
                        image 'httpssulfur.wiki.ggimagesthumb00fLung.png100px-Lung.pngf099b2',
                        type 'ingredient', gridSize '1x2', sellPrice 30, buyPrice 0,
                        soldBy 'Grossberg', effect '', statsModifiers '',
                        flavorText 'Used to give, and take, someones breath away.'
                    },
                    'Matcha' {
                        image 'httpssulfur.wiki.ggimages22eMatcha.png162549',
                        type 'Consumable', gridSize '1x1', sellPrice 20, buyPrice 40,
                    ...
                    'Metal Scrap' {
                        image 'httpssulfur.wiki.ggimages004Metal_Scrap.png38d870',
                    ...
                    'Mineral Water' {
                        image 'httpssulfur.wiki.ggimagesthumb55eMineral_Water.png91px-Mineral_Water.png895ca9',
                    ...
                    'Mycota Squamata' {
                        image 'httpssulfur.wiki.ggimagesthumbdd3Mycota_Squamata.png88px-Mycota_Squamata.png68c989',
                    ...
                    'Mystery Meat' {                 -Why not just get the info directly from the wiki Because I don't know how and now I'm too deep into this!
                        image 'httpssulfur.wiki.ggimages445Mystery_Meat.pnga14248',
                        type 'Consumable', gridSize '1x1', sellPrice 30, buyPrice 60,
                    ...
                    'Nut Mix' {
                        image 'httpssulfur.wiki.ggimages11cNut_Mix.png6f2e41',
                    ...
                    'Oats' {
                        image 'httpssulfur.wiki.ggimagesthumb334Oats.png128px-Oats.png7b8685',
                        type 'Consumable', gridSize '1x2', sellPrice 30, buyPrice 0,
                        soldBy '', effect 'Heal 10 health over 3 seconds', statsModifiers '',
                        flavorText 'Great for baking or making porridge.'
                    },
                    'Pancreas' {
                        image 'httpssulfur.wiki.ggimagesthumb55bPancreas.png200px-Pancreas.png76437f',
                    ...
                    'Paper' {
                        image 'httpssulfur.wiki.ggimagesthumbbb2Paper.png160px-Paper.pngf1514b',
                    ...
                    'Peanut' {
                        image 'httpssulfur.wiki.ggimagesff6Peanut.png57608c',
                        type 'Consumable', gridSize '1×1', sellPrice 10, buyPrice 20,
                        soldBy 'Stiffleg', effect 'Heal 5 health over 5 seconds', statsModifiers '',
                        flavorText 'Easy to crack. Tasty and nutritious.'
                    },
                    'Peanut Butter' {
                        image 'httpssulfur.wiki.ggimagesthumbdd5Peanut_Butter.png141px-Peanut_Butter.png7d8248',
                    ...
                    'Pine Nuts' {
                        image 'httpssulfur.wiki.ggimages114Pine_Nuts.pnge2f7fd',
                        type 'Consumable', gridSize '1×1', sellPrice 10, buyPrice 20,
                        soldBy 'Stiffleg, Jaques De Fector', effect 'Heal 5 health over 5 seconds', statsModifiers '',
                        flavorText 'Hard to crack. But tasty.'
                    },
                    'Pizza' {
                        image 'httpssulfur.wiki.ggimagesff4Pizza.png173ce0',
                    ...
                    'Plain White Tee' {
                        image 'httpssulfur.wiki.ggimagesthumb55dPlain_White_Tee.png188px-Plain_White_Tee.pngcb4998',
                    ...
                    'Porridge' {
                        image 'httpssulfur.wiki.ggimages55dPorridge.pngc67880',
                    ...
                    'Potato' {
                        image 'httpssulfur.wiki.ggimagescc2Potato.png6222da',
                    ...
                    'Red Wine' {
                        image 'httpssulfur.wiki.ggimagesthumb991Red_Wine.png56px-Red_Wine.pngb10d97',
                    ...
                    'Rhubarb' {
                        image 'httpssulfur.wiki.ggimagesthumb66eRhubarb.png86px-Rhubarb.png2dd560',
                        type 'Consumable', gridSize '1x2', sellPrice 20, buyPrice 0,
                    ...
                    'Rhubarb Sauce' {
                        image 'httpssulfur.wiki.ggimagesdd2Rhubarb_Sauce.pngc73eac',
                    ...
                    'Rice' {                          -You could've just used an Ai to write down all the info  NO! I tried... they're to dumb they can't access the wiki. I had to write all this down...
                        image 'httpssulfur.wiki.ggimagesthumbddaRice.png200px-Rice.pngc62a6c',
                    ...
                    'Robot Hydraul' {
                        image 'httpssulfur.wiki.ggimagesthumbbb6Robot_Hydraul.png160px-Robot_Hydraul.png83eb2c',
                    ...
                    'Robot Septacoil' {
                        image 'httpssulfur.wiki.ggimagesthumbdd7Robot_Septacoil.png100px-Robot_Septacoil.png69eb42',
                        type 'Ingredient', gridSize '1x2', sellPrice 50, buyPrice 0,
                        soldBy '', effect '', statsModifiers '',
                        flavorText 'Gives robots that springy step, or that recoily force.'
                    },
                    'Rock' {
                        image 'httpssulfur.wiki.ggimages00bRock.pngffa447',
                    ...
                    'Rubber' {
                        image 'httpssulfur.wiki.ggimages88eRubber.pngc69f3a',
                        type 'Ingredient', gridSize '1x1', sellPrice 5, buyPrice 0,
                        soldBy '', effect '', statsModifiers '',
                    ...
                    'Rödsopp' {
                        image 'httpssulfur.wiki.ggimages44dR%C3%B6dsopp.png2b76f4',
                    ...
                    'Salt' {
                        image 'httpssulfur.wiki.ggimages777Salt.png29c966',
                        type 'Consumable', gridSize '1x1', sellPrice 5, buyPrice 0,
                        soldBy '', effect 'Heal 1 health over 2 seconds', statsModifiers '',
                        flavorText 'The white gold of millenia. Great to mix with liquid for broths, making foods tastier. '
                    },
                    'Salted Fish' {
                        image 'httpssulfur.wiki.ggimages77bSalted_Fish.png695bc3',
                        type 'Consumable', gridSize '1x1', sellPrice 45, buyPrice 90,
                    ...
                    'Salted Sandfish' {
                        image 'httpssulfur.wiki.ggimagesff0Salted_Sandfish.pngef5b4e',
                        type 'Consumable', gridSize '1x1', sellPrice 50, buyPrice 100,
                        soldBy '', effect 'Heal 20 health over 4 seconds.', statsModifiers '',
                        flavorText 'Salty and fishy.'
                    },
                    'Sawdust' {
                        image 'httpssulfur.wiki.ggimages888Sawdust.pngeca698',
                        type 'Ingredient', gridSize '1x1', sellPrice 5, buyPrice 0,
                        soldBy '', effect '', statsModifiers '',
                        flavorText 'Wood shredded into powderous dust.'
                    },
                    'Seaweed' {
                        image 'httpssulfur.wiki.ggimages113Seaweed.png1d0f60',
                        type 'Consumable', gridSize '1x1', sellPrice 15, buyPrice 30,
                    ...
                    'ShavWa Flesh' {
                        image 'httpssulfur.wiki.ggimagesthumb883Shav%27Wa_Flesh.png200px-Shav%27Wa_Flesh.pngeb633c',
                        type 'Ingredient', gridSize '1x1', sellPrice 25, buyPrice 0,
                        soldBy '', effect '', statsModifiers '',
                        flavorText 'Smells like... sweet fish. Hard to describe.'
                    },
                    'ShavWa Skin' {
                        image 'httpssulfur.wiki.ggimagesthumbbbdShav%27Wa_Skin.png200px-Shav%27Wa_Skin.png8cf32d',
                        type ' Ingredient', gridSize '1x1', sellPrice 50, buyPrice 0,
                        soldBy '', effect '', statsModifiers '',
                        flavorText 'Scaley yet flexible.'
                    },
                    'Skimmed Milk' {
                        image 'httpssulfur.wiki.ggimagesthumbdd2Skimmed_Milk.png100px-Skimmed_Milk.pngca4cfe',
                        type 'Consumable', gridSize '1×2', sellPrice 20, buyPrice 40,
                    ...
                    'Snail' {
                        image 'httpssulfur.wiki.ggimagesdd2Snail.png9aab5c',
                    ...
                    'Soda' {
                        image 'httpssulfur.wiki.ggimagescc4Soda.png1008b8',
                        type 'Consumable', gridSize '1x1', sellPrice 15, buyPrice 30,
                    ...
                    'Solution' {
                        image 'httpssulfur.wiki.ggimages885Solution.pngb1f02a',
                        type 'Consumable', gridSize '1x1', sellPrice 20, buyPrice 0,
                    ...
                    'Spaghetti' {
                        image 'httpssulfur.wiki.ggimagesthumb008Spaghetti.png66px-Spaghetti.png40ec51',
                    ...
                    'Spice Mix' {
                        image 'httpssulfur.wiki.ggimages77cSpice_Mix.pngfa3334',
                        type 'Item', gridSize '1x1', sellPrice 15, buyPrice 30,
                        soldBy 'Grossberg', effect '', statsModifiers '',
                        flavorText 'An exotic mix of spices that can be used for many purposes.'
                    },
                    'Spicy Sausage' {
                        image 'httpssulfur.wiki.ggimagesffbSpicy_Sausage.png9142eb',
                        type 'Consumable', gridSize '2x1', sellPrice 30, buyPrice 60,
                        soldBy 'Grossberg', effect 'Heal 30 health over 5 seconds', statsModifiers '',
                        flavorText 'A spicy smoked sausage.'
                    },
                    'Spleen' {
                        image 'httpssulfur.wiki.ggimagesthumb337Spleen.png200px-Spleen.png18927d',
                        type 'Ingredient', gridSize '1x1', sellPrice 20, buyPrice 0,
                        soldBy 'Grossberg', effect '', statsModifiers '',
                        flavorText 'A must have for any blood user.'
                    },
                    'Sports Drink' {
                        image 'httpssulfur.wiki.ggimagesthumb00eSports_Drink.png69px-Sports_Drink.png77840d',
                        type 'Consumable', gridSize ' 1x2', sellPrice 60, buyPrice 120,
                    ...
                    'Stick' {
                        image 'httpssulfur.wiki.ggimagesaaaStick.png76f2ec',
                        type 'Consumable', gridSize '2x1', sellPrice 2, buyPrice 4,
                        soldBy '', effect '', statsModifiers '',
                        flavorText 'Nothing compares to a really good stick.'
                    },
                    'Stout' {
                        image 'httpssulfur.wiki.ggimagesthumb770Stout.png74px-Stout.pnge5dbb3',
                        type 'Consumable', gridSize '1x2', sellPrice 20, buyPrice 0,
                    ...
                    'Sugar' {
                        image 'httpssulfur.wiki.ggimagesaa9Sugar.png24833e',
                        type 'Consumable', gridSize '2x2', sellPrice 15, buyPrice 0,
                        soldBy '', effect 'Heal 10 health over 10 seconds', statsModifiers '',
                        flavorText 'Makes things sweeter.'
                    },
                    'Swing-Ding' {
                        image 'httpssulfur.wiki.ggimages88cSwing-Ding.pngb42c43',
                        type 'Consumable', gridSize '1x1', sellPrice 5, buyPrice 10,
                    ...
                    'Thyroid' {
                        image 'httpssulfur.wiki.ggimagesthumb88aThyroid.png200px-Thyroid.png8858a2',
                        type 'Ingredient', gridSize '1x1', sellPrice 35, buyPrice 0,
                        soldBy 'Grossberg', effect '', statsModifiers '',
                        flavorText 'An organ roughly the shape of a certain rap group logo. Apparently secretes hormones all over your body Yuck.'
                    },
                    'Tongue' {
                        image 'httpssulfur.wiki.ggimagesthumbcc4Tongue.png200px-Tongue.png62a500',
                        type 'Ingredient', gridSize '1x1', sellPrice 50, buyPrice 0,
                        soldBy '', effect '', statsModifiers '',
                        flavorText 'The talky lick muscle. Makes things taste like stuff.'
                    },
                    'Tube Caviar' {
                        image 'httpssulfur.wiki.ggimages442Tube_Caviar.png5557ee',
                    ...
                    'Used Rubber' {
                        image 'httpssulfur.wiki.ggimages773Used_Rubber.pngae1964',
                    ...
                    'Velvet Bell' {
                        image 'httpssulfur.wiki.ggimagesthumb550Velvet_Bell.png80px-Velvet_Bell.png3617b4',
                        type 'Consumable', gridSize '1x1', sellPrice 5, buyPrice 10,
                        soldBy '', effect 'Heal 1 health over 1 second', statsModifiers '',
                        flavorText 'This meaty mushroom carries an earthy and nutty smell. Can be used in cooking.'
                    },
                    'Walnut' {
                        image 'httpssulfur.wiki.ggimagesff6Walnut.png483f06',
                        type 'Consumable', gridSize '1×1', sellPrice 20, buyPrice 0,
                        soldBy 'Stiffleg', effect 'Heal 5 health over 5 seconds', statsModifiers '',
                        flavorText 'Hard to crack. But tasty.'
                    },
                    'Whole Milk' {
                        image 'httpssulfur.wiki.ggimagesthumb00fWhole_Milk.png125px-Whole_Milk.png4df06b',
                        type 'Consumable', gridSize '1x2', sellPrice 20, buyPrice 40,
        ...
        'Admiral White Extra Strong' {
            image 'httpssulfur.wiki.ggimages229Admiral_White_Extra_Strong.png670694',
        ...
        'Aspic' {
           image 'httpssulfur.wiki.ggimages112Aspic.pngbac645',
        ...
        'Banana Bread' {
           image 'httpssulfur.wiki.ggimages335Banana_Bread.pngffd5cb',
        ...
        'Banana Sulfs' {
           image 'httpssulfur.wiki.ggimagesffaBanana_Sulfs.png88142f',
        ...
        'Berry Jam (Unsweetened)' {
           image 'httpssulfur.wiki.ggimages66dBerry_Jam_%28Unsweetened%29.png1d7609',
        ...
        'Berry Milkshake' {
           image 'httpssulfur.wiki.ggimagesthumb55aBerry_Milkshake.png75px-Berry_Milkshake.png57a02b',
        ...
        'Biscuits And Gravy' {
           image 'httpssulfur.wiki.ggimages222Biscuits_And_Gravy.png7fa79f',
        ...
        'Boba Tea' {
           image 'httpssulfur.wiki.ggimagesthumb00aBoba_Tea.png79px-Boba_Tea.pnga34233',
        ...
        'Bread Sandwich' {
           image 'httpssulfur.wiki.ggimages111Bread_Sandwich.png685623',
        ...
        'Buddy Sandwich' {
           image 'httpssulfur.wiki.ggimagesthumb00aBuddy_Sandwich.png262px-Buddy_Sandwich.png188fe2',
        ...
        'Butter Sandwich' {
           image 'httpssulfur.wiki.ggimagesbb7Butter_Sandwich.pnge7e460',
        ...
        'Buttermilk Pancakes' {
           image 'httpssulfur.wiki.ggimagescc5Buttermilk_Pancakes.png4f62d2',
        ...
        'Cactus Softdrink' {
           image 'httpssulfur.wiki.ggimagesthumb00bCactus_Softdrink.png82px-Cactus_Softdrink.png7edd8a',
        ...
        'Candy Cane' {
           image 'httpssulfur.wiki.ggimages113Candy_Cane.png71f0e5',
        ...
        'Cereal' {
           image 'httpssulfur.wiki.ggimagesthumb991Cereal.png200px-Cereal.png2b5a97',
        ...
        'Cevapi' {
           image 'httpssulfur.wiki.ggimages00bCevapi.pngc83c9c',
        ...
        'Cheese Sandwich' {
           image 'httpssulfur.wiki.ggimagesee7Cheese_Sandwich.pngc37759',
        ...
        'Cheese Tops' {
           image 'httpssulfur.wiki.ggimages440Cheese_Tops.png5b9db1',
        ...
        'Cheeseburger' {
           image 'httpssulfur.wiki.ggimages111Cheeseburger.png684682',
        ...
        'Chocolate Ball' {
           image 'httpssulfur.wiki.ggimages770Chocolate_Ball.png8c4ac3',
        ...
        'Chocolate Milkshake' {
           image 'httpssulfur.wiki.ggimagesthumb88cChocolate_Milkshake.png94px-Chocolate_Milkshake.png57a02b',
        ...
        'Chocolate Mudcake' {
           image 'httpssulfur.wiki.ggimages448Chocolate_Mudcake.pnga29142',
        ...
        'Cordon Bleu' {
           image 'httpssulfur.wiki.ggimagesthumb444Cordon_Bleu.png200px-Cordon_Bleu.png39f4b2',
        ...
        'Cotton Candy' {
           image 'httpssulfur.wiki.ggimagesthumb667Cotton_Candy.png98px-Cotton_Candy.pngb575f1',
        ...
        'Cotton Swabs' {
           image 'httpssulfur.wiki.ggimagesbb9Cotton_Swabs.pngd36116',
        ...
        'Cuisses De Grenouille' {
           image 'httpssulfur.wiki.ggimages117Cuisses_De_Grenouille.pnge234e4',
        ...
        'Currywurst' {
           image 'httpssulfur.wiki.ggimagesthumb66aCurrywurst.png200px-Currywurst.png80ac77',
        ...
        'Dimmie' {
           image 'httpssulfur.wiki.ggimages112Dimmie.png6c4240',
        ...
        'Dopp I Grytan' {
           image 'httpssulfur.wiki.ggimagesthumbddbDopp_I_Grytan.png160px-Dopp_I_Grytan.png951131',
        ...
        'Double Cheeseburger' {
           image 'httpssulfur.wiki.ggimagescceDouble_Cheeseburger.pngadf784',
        ...
        'Dumpling' {
           image 'httpssulfur.wiki.ggimages228Dumpling.png1a822e',
        ...
        'Egg Toddy' {
           image 'httpssulfur.wiki.ggimages662Egg_Toddy.png5ffe88',
        ...
        'Energy Gum' {
           image 'httpssulfur.wiki.ggimages775Energy_Gum.png59af46',
        ...
        'Escargot' {
           image 'httpssulfur.wiki.ggimagesthumb778Escargot.png200px-Escargot.png1a9efc',
        ...
        'First Aid Kit' {
           image 'httpssulfur.wiki.ggimagesthumb550First_Aid_Kit.png220px-First_Aid_Kit.pngf797b1',
        ...
        'Fish And Chips' {
           image 'httpssulfur.wiki.ggimagesthumb995Fish_And_Chips.png200px-Fish_And_Chips.pngfed773',
        ...
        'Fondue' {
           image 'httpssulfur.wiki.ggimages333Fondue.png87575e',
        ...
        'French Hotdog' {
           image 'httpssulfur.wiki.ggimages11fFrench_Hotdog.png84aa74',
        ...
        'French Toast' {
           image 'httpssulfur.wiki.ggimagesaadFrench_Toast.png324996',
        ...
        'Fried Blood Pudding' {
           image 'httpssulfur.wiki.ggimagesff5Fried_Blood_Pudding.png397485',
           type 'Consumable', gridSize '2×1', sellPrice 45, buyPrice 90, statsModifiers '', effect 'Heal 30 health over 10 seconds',
        ...
        'Fried Mushroom' {
           image 'httpssulfur.wiki.ggimages44aFried_Mushroom.pnge3246e',
        ...
        'Full English Breakfast' {
           image 'httpssulfur.wiki.ggimages445Full_English_Breakfast.pngbaf5f0',
        ...
        'Green Tea Gum' {
           image 'httpssulfur.wiki.ggimagesff4Green_Tea_Gum.pngf060a4',
        ...
        'Grilled Cactus' {
           image 'httpssulfur.wiki.ggimagesbb2Grilled_Cactus.png2eea51',
        ...
        'Haggis' {
           image 'httpssulfur.wiki.ggimagesthumbaaeHaggis.png200px-Haggis.pngf35fe9',
        ...
        'Hard Bread' {
           image 'httpssulfur.wiki.ggimages886Hard_Bread.pngf8eafa',
        ...
        'Hardshell Taco' {
           image 'httpssulfur.wiki.ggimages00aHardshell_Taco.png651563',
        ...
        'Health Potion' {
           image 'httpssulfur.wiki.ggimagesthumb553Health_Potion.png160px-Health_Potion.png2eb287',
        ...
        'Hot Pot' {
           image 'httpssulfur.wiki.ggimagesthumb448Hot_Pot.png300px-Hot_Pot.pngea413d',
        ...
        'Hot Sauce' {
           image 'httpssulfur.wiki.ggimagesthumb002Hot_Sauce.png65px-Hot_Sauce.pnga776ff',
        ...
        'Jansson`s Temptation' {
           image 'httpssulfur.wiki.ggimagesthumb225Jansson%27s_Temptation.png300px-Jansson%27s_Temptation.pngcb6ed3',
        ...
        'Julmust' {
           image 'httpssulfur.wiki.ggimagesthumb99fJulmust.png79px-Julmust.png1a4ef6',
        ...
        'Kidney Pie' {
           image 'httpssulfur.wiki.ggimagesffcKidney_Pie.pngaeff24',
        ...
        'Lackerol Cactus' {
           image 'httpssulfur.wiki.ggimagescc0Lackerol_Cactus.pngfd95ca',
        ...
        'Liver Pâté Sandwich' {
           image 'httpssulfur.wiki.ggimages33eLiver_P%C3%A2t%C3%A9_Sandwich.png26e5dd',
        ...
        'Lutfisk' {
           image 'httpssulfur.wiki.ggimagesbbaLutfisk.png1336f9',
        ...
        'Mac`n`Cheese' {
           image 'httpssulfur.wiki.ggimagesthumb33dMac%27n%27Cheese.png200px-Mac%27n%27Cheese.pngf7c37a',
        ...
        'Maki' {
           image 'httpssulfur.wiki.ggimages221Maki.png2432e3',
        ...
        'Mashed Potatoes' {
           image 'httpssulfur.wiki.ggimagesdd6Mashed_Potatoes.png31a620',
        ...
        'Meat Skewer' {
           image 'httpssulfur.wiki.ggimages003Meat_Skewer.pngc744dd',
        ...
        'Meringue' {
           image 'httpssulfur.wiki.ggimages11fMeringue.pnge91af0',
        ...
        'Mochi' {
           image 'httpssulfur.wiki.ggimages445Mochi.png2ceb21',
        ...
        'Mulled Wine' {
           image 'httpssulfur.wiki.ggimages11dMulled_Wine.pngb83330',
        ...
        'Mushroom Omelette' {
           image 'httpssulfur.wiki.ggimagesbb7Mushroom_Omelette.pnge7b264',
        ...
        'Mushroom Skewer' {
           image 'httpssulfur.wiki.ggimages228Mushroom_Skewer.png757328',
        ...
        'Mushroom Soup' {
           image 'httpssulfur.wiki.ggimagesdd7Mushroom_Soup.png8002d5',
        ...
        'Nashville Hot Chicken' {
           image 'httpssulfur.wiki.ggimagesdd7Nashville_Hot_Chicken.pnga37fde',
        ...
        'Nigiri' {
           image 'httpssulfur.wiki.ggimagesthumb226Nigiri.png200px-Nigiri.pngf1b194',
        ...
        'Nuggets' {
           image 'httpssulfur.wiki.ggimagesthumbaa5Nuggets.png200px-Nuggets.png7d7296',
        ...
        'Nut Mix' {
            image 'httpssulfur.wiki.ggimages11cNut_Mix.png6f2e41', Who makes a recipe that says same nut or other same So much work because of this once recipe! ｡゜(｀Д´)゜｡
        ...
        'Nut Spread' {
           image 'httpssulfur.wiki.ggimagesthumbdd6Nut_Spread.png141px-Nut_Spread.pngcab8ee',
        ...
        'Omelette' {
           image 'httpssulfur.wiki.ggimagesthumb223Omelette.png200px-Omelette.pngf0756d',
        ...
        'Onigiri' {
           image 'httpssulfur.wiki.ggimagesthumbff3Onigiri.png200px-Onigiri.png229481',
        ...
        'Peanutbutter Jelly Sandwich' {
           image 'httpssulfur.wiki.ggimages999Peanutbutter_Jelly_Sandwich.png5cc763',
        ...
        'Peanutbutter Sandwich' {
           image 'httpssulfur.wiki.ggimages44dPeanutbutter_Sandwich.pngeb78c6',
        ...
        'Pickled Herring Platter' {
           image 'httpssulfur.wiki.ggimagesddcPickled_Herring_Platter.pngbdcdfe',
        ...
        'Poutine' {
          image 'httpssulfur.wiki.ggimages114Poutine.png7754eb',
        ...
        'Power Bar' {
            image 'httpssulfur.wiki.ggimages88ePower_Bar.png7c8d17',
          ...
          'Puffed Rice Cakes' {
              image 'httpssulfur.wiki.ggimages881Puffed_Rice_Cakes.png94fc4a',
        ...
        'Pyttipanna' {
          image 'httpssulfur.wiki.ggimages44fPyttipanna.pngd3bef7',
        ...
        'Pölsa' {
          image 'httpssulfur.wiki.ggimages22aP%C3%B6lsa.png794b22',
        ...
        'Pølse' {
           image 'httpssulfur.wiki.ggimages006P%C3%B8lse.png43812f',
        ...
        'Raclette' {
           image 'httpssulfur.wiki.ggimages66eRaclette.png8ff55a',
           type 'Consumable', gridSize '2×1', sellPrice 150, buyPrice 300, statsModifiers '', effect 'Heal 50 health over 4 seconds',
        ...
        'Ramen' {
           image 'httpssulfur.wiki.ggimagesff8Ramen.pngc50742',
        ...
        'Rhubarb Pie' {
           image 'httpssulfur.wiki.ggimages221Rhubarb_Pie.png6617a2',
        ...
        'Rhubarb Porridge' {
           image 'httpssulfur.wiki.ggimagesddbRhubarb_Porridge.png63a191',
        ...
        'Rice Porridge' {
           image 'httpssulfur.wiki.ggimagesthumb66fRice_Porridge.png252px-Rice_Porridge.pnge731c0',
        ...
        'Rödsopp Paste' {
           image 'httpssulfur.wiki.ggimages33bR%C3%B6dsopp_Paste.png34717e',
        ...
        'Sashimi' {
           image 'httpssulfur.wiki.ggimagesthumb441Sashimi.png200px-Sashimi.pngcb4a45',
        ...
        'Sausage Omelette' {
           image 'httpssulfur.wiki.ggimages338Sausage_Omelette.png72f7b6',
        ...
        'Sausage On Stick' {
           image 'httpssulfur.wiki.ggimages668Sausage_On_Stick.png74d3ea',
        ...
        'Sausage Soup' {
           image 'httpssulfur.wiki.ggimages33bSausage_Soup.pnga9aa1a',
        ...
        'Spaghetti Bolognese' {
           image 'httpssulfur.wiki.ggimages446Spaghetti_Bolognese.png34d90f',
        ...
        'Spanish Omelette' {
           image 'httpssulfur.wiki.ggimagesff2Spanish_Omelette.png168802',
        ...
        'Stew' {
           image 'httpssulfur.wiki.ggimagesthumb331Stew.png200px-Stew.pngea6648',
        ...
        'Surströmming' {
           image 'httpssulfur.wiki.ggimages77fSurstromming.png748c56',
        ...
        'Swedish Pancakes' {
           image 'httpssulfur.wiki.ggimagesdd7Swedish_Pancakes.pnga049ad',
        ...
        'Sweet Gum' {
           image 'httpssulfur.wiki.ggimagesbb7Sweet_Gum.png3d1c51',
        ...
        'Toast Skagen' {
           image 'httpssulfur.wiki.ggimages119Toast_Skagen.png9f8d73',
        ...
        'Tongue On Stick' {
           image 'httpssulfur.wiki.ggimages00cTongue_On_Stick.png6acb5a',
        ...
        'Tori Ramen' {
           image 'httpssulfur.wiki.ggimages222Tori_Ramen.pnge03af8',
        ...
        'Unagi' {
           image 'httpssulfur.wiki.ggimages336Unagi.pngca8a54',
        ...
        'Vacuum Cleaner' {
           image 'httpssulfur.wiki.ggimagesff6Vacuum_Cleaner.png22d405',
    ...
    class RecipeEngine {
        ...
        extractQuantity(partString) {
            const quantityMatch = partString.match((.+)sx(d+)$);
            if (quantityMatch) {
        ...
        canAllocateConstraint(constraint, ingredients, usage = {}, actuallyAllocate = false) {
            ...
            if (constraint.category) {
                ...
                if (constraint.modifiers.includes('three different')) {
                 ...
                 Handle other modifiers (sameotherother same)
                for (const ingredient of filteredIngredients) {
                    const available = (ingredients[ingredient]  0) - (usage[ingredient]  0);
    ...
    class TooltipManager {
     ...
     MAIN CONTROLLER - Make a simple list no! why It's only 5 am and I'm blasting エゴイスト - Paseri Onuma. I'm having a great time! Here's my playlist if you want shh don't tell anyone httpsmusic.youtube.complaylistlist=PLLTJvY-u4-eC2p5er4YZJU3AH2UNyzvZl&si=uVs5wf9I8qkn_7w9
    ...
    class SulfurCalculator {
        ...
        createLeftPanel() {
            ...
            patternsDiv.innerHTML = 'div class=no-patternsSelect a recipe to view patternsdiv';
        ...
        createRightPanel() {
            ...
            detailsDiv.innerHTML = 'divSelect an item to view detailsdiv';
        ...
        displayAvailableRecipes(availableRecipes) {
            ...
            if (availableRecipes.length === 0) {
                container.innerHTML = 'div class=no-recipesAdd ingredients to see available recipesdiv';
                return;
            }
        ...
        displayRecipePatterns(recipeName, patterns) {
            ...
            if (!patterns  patterns.length === 0) {
                container.innerHTML = 'div class=no-patternsNo patterns found for this recipediv';
                return;
            }
        ...
        displayDetails(name, type) {
            ...
            if (!data) {
                container.innerHTML = 'divNo details availablediv';
                return;
            }
        ...
        displayFavoriteRecipes(recipes) {
            ...
            if (recipes.length === 0) {
                container.innerHTML = 'div class=no-recent-recipeNo favorite recipesdiv';
                return;
            }
        ...
        createTooltip(name, type) {
            ...
            if (data.soldBy) {
                tooltip += `div class=tooltip-infoSold by ${data.soldBy}div`;
            }
        ...
        generateDetailsHTML(name, data, heartType, isFavorited) {
            ...
            if (data.type  data.gridSize) {
                sections.push(`
                    div class=recipe-info
                        ...
                        ${data.gridSize  `divGrid Size ${data.gridSize}div`  ''}
                    div
                `);
            }

            if (data.effect) {
                sections.push(`div class=dividerdivdiv class=recipe-infodiv${data.effect}divdiv`);
            }

            if (data.statsModifiers) {
                sections.push(`div class=dividerdivdiv class=recipe-infodiv${data.statsModifiers}divdiv`);
            }
            ...
            if (data.sellPrice  data.buyPrice) {
                sections.push(`
                    ...
                    div class=recipe-info
                        ${data.sellPrice  `div class=currencySelling ${data.sellPrice} img src=${sulfCoinURL} alt=SulfCoindiv`  ''}
                        ${data.buyPrice  `div class=currencyBuying ${data.buyPrice} img src=${sulfCoinURL} alt=SulfCoindiv`  ''}
                    div
                `);
            }

            if (data.soldBy) {
                sections.push(`div class=dividerdivdiv class=recipe-infodivSold by ${data.soldBy}divdiv`);
            }

            if (data.flavorText) {
                sections.push(`div class=dividerdivdiv class=recipe-infodiv${data.flavorText}divdiv`);
            }
...
${JSON.stringify(data, null, 2)}`;
        ...
        processImport(content) {
            Utils.safeOperation(() = {
                ...
                const jsonContent = lines.slice(jsonStart).join('n');
    ...
    GM_addStyle(`
        ...
        .recipe-itemhover, .search-result-itemhover {
            background #5A2020;
        }
        ...
        .recipes-list-webkit-scrollbar-thumbhover,
        .recipe-patterns-webkit-scrollbar-thumbhover,
        .recipe-details-webkit-scrollbar-thumbhover,
        .search-results-webkit-scrollbar-thumbhover {
            background #ffbb33;
